...
#beginning of script. while "ans" variable is true run script block. 
ans=True
while ans:
    
    #options menu printed to screen.
    print ("""
    ...
    #user input requested and attached to "ans" variable.
    ans=raw_input(">")
    
    #beginning of if statement. if input is 1 the script block following the colon is run, else it skips to the next elif statement.
    if ans=="1":
        
      #user input requested and attached to "mystring" variable.   
      mystring = raw_input ('Please enter a string: ')
      
      #"mystring" variable hashed using the hashlib encryption type defined and set to a variable.
    ...
    #if user input "ans" is not 1, check if it's 2. if it is, run the script block following the colon, else skip to the next elif statement. 
    elif ans=="2":
    ...
    #if user input "ans" is not 2, check if it's 3. if it is, run the script block following the colon, else skip to the next elif statement.  
    elif ans=="3":

      #exit the script  
      sys.exit()
      
    #if user input "ans" is not equal to 1,2 or 3, print message to screen and return to beginning of script.  
    elif ans !="":
